...
class Businesses {
  ...
  late final int? totalEmployee;
  late final String isPromot;
  late final String emailShow;
  late final String phoneShow;
  late final String? businessOverview;
  late final String? facilitiesOverview;
  late final String? prodnservOverview;
  late final String? reasonforsale;
  late final Null industryPreference;
  late final String? locationPreference;
  late final String? assets;
  late final int? monthlySale;
  late final String? monthlySaleCurrency;
  //late final int? reportedSales;
  late final String? reportedSaleCurrency;
  late final int? targetSellingPrice;
  late final String? targetSellingPriceCurrency;
  late final int? physicalAssetsValue;
  late final String? physicalAssetsValueCurrency;
  ...
  late final String? ebitdaMargin;
  late final Null established;
  late final Null employeeCapacity;
  late final String? legalEntry;
  //late final String? reportedSales;
